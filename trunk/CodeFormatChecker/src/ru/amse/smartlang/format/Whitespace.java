...
public final class Whitespace implements Comparable<Whitespace> {
	...
	public static final Whitespace EMPTY = getInstance(0, 0, 0); 
	...
	public String toString() {
		return "(new_lines = " + newLines + ", indents = " + indents + ", spaces = " + spaces + ")";
	}

	public int compareTo(Whitespace o) {
		if(newLines != o.newLines) {
			return newLines - o.newLines;
		}
		if(indents != o.indents) {
			return indents - o.indents;
		}
		return spaces - o.spaces;
	}
